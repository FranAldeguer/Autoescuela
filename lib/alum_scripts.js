function insertar_modificar(){
    ...
    if(nom == ''){
        ...
        $.post('http://localhost/Autoescuela/controles/Control_alumnos.php', {inputid:id, inputdni:dni, inputnom:nom, inputape: ape, inputfecha_nac:fnac, inputtelf:telf, inputmail:mail, selectidprof:id_prof},
        function(data){
...
function borrar(id, nombre, td){
    ...
    if (ventana) {
        $.post('http://localhost/Autoescuela/controles/Control_alumnos.php', {funcion: "borrar_usuario", id_alu: id},
            function (data){});
            removeTR(td);
    }
    else {
