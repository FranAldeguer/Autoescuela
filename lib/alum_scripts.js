	...
	$.post(
        ...
        function(datos){
            ...
            if(id_comporobacion == 0){
                ...
                var lista = "";
                lista += '<tr id='+data+'">';
                //lista += '<td class="id">'+data+'</td>'; //Id
                lista += '<td class="dni">'+dni+'</td>'; //DNI
                lista += '<td class="nombre">'+nom+'</td>'; //Nombre
                lista += '<td class="apellidos">'+ape+'</td>'; //Apellidos
                lista += '<td class="fecha_nac">'+fnac+'</td>'; //Fecha de nacimiento
                lista += '<td class="telefono">'+telf+'</td>'; //Telefono
                lista += '<td class="mail">'+mail+'</td>'; //Email
                lista += '<td class="id_prof">'+id_prof+'</td>'; //Id profesor
