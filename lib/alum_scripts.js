function insertar_modificar(){
    ...
    if(nom == '' || isNaN(telf)){
        ...
        $.post('http://localhost/ProyectoAutoescuela/controles/Control_alumnos.php', {inputid:id, inputdni:dni, inputnombre:nom, inputapellidos: ape, inputfecha_nac:fnac, inputtelefono:telf, inputmail:mail, selectid_profesor:id_prof},
        function(data){
