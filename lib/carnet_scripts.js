function insertar_modificar(){
    ...
    if(nom == ''){
        ...
        $.post('http://localhost/Autoescuela/controles/Control_carnets.php', {inputid:id, inputnom:nom, inputpre: pre, inputdesc:desc},
        function(data){
...
function borrar(id, nombre, td){
    ...
    if (ventana) {
        $.post('http://localhost/Autoescuela/controles/Control_carnets.php', {funcion: "borrar_usuario", id_car: id},
            function (data){});
            removeTR(td);
    }
    else {
