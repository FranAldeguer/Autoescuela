...
# Generation Time: 2013-05-09 19:13:00 +0000
# ************************************************************
...
INSERT INTO `alumno` (`id`, `dni`, `nombre`, `apellidos`, `fecha_nac`, `telefono`, `mail`, `id_profesor`, `pass`)
VALUES
	(779,'66686082y','Miguel','Abellan Pleguezuelos','2000-10-11',725668042,'lybjrl@pao.gui',0,'peep'),
	(780,'40588931i','Antonio','Galvan Fernandez','2004-02-04',682242505,'kaixzkhrxt@xiy.dh',NULL,'thlj'),
	(782,'46093540m','Juan','Perez Fernandez','2005-09-13',766573523,'ASDF',0,'ikbh'),
	(783,'25701592k','Angelina','Ortega Mas','2008-09-04',766105858,'pmkkybaajj@fn.zem',0,'hpoo'),
	(784,'79910260z','Guillermo','Galvan Mas','2008-09-21',711875250,'hbbrads@md.sq',0,'uruh'),
	(786,'67372421z','Felipe','Guzman Fernandez','2007-11-06',649079537,'bth@bep.rau',0,'hdsa'),
	(787,'99169512s','Encarni','Galvan Tortosa','2002-08-29',773199033,'fn@ktclo.yp',0,'oomg'),
	(788,'63388730i','Juan','Hernandez Perez','2006-09-25',759675798,'sahqvjvj@gek.suq',0,'ikgv');
...
INSERT INTO `profesor` (`id`, `dni`, `nombre`, `apellidos`, `telefono`, `email`, `practico`, `encargado`, `pass`)
VALUES
	(0,NULL,'--Sin Profesor--',NULL,NULL,NULL,0,0,NULL);
